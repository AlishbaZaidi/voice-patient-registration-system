# The Patient table definition. String(36) is used for the UUID
# column instead of a Postgres-specific UUID type, so the exact
# same code works on both SQLite (dev) and Postgres (prod).
import uuid
